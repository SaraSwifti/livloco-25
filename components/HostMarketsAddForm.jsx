  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && res.id) {
        ...
        alert(
          res.error ||
            'There was a problem saving your market. Please try again.'
        )
      }
    } catch (err) {
      console.error('Submission failed:', err)
      alert(
        'There was a problem saving your market. Please check your inputs and try again.'
      )
    }
  }
    ...
    >
      <div className='bg-white p-4 rounded border'>
        <div className='flex items-center gap-3'>
          ...
          />
          <label
            htmlFor='skip_host_market_profile'
            className='font-medium text-lg'
          >
            Skip adding a Hosted Farmers’ Market profile for now and just peruse
            as a LivLoco Co-op Member.
          </label>
        </div>
        {showSkipPopout && (
      ...
      <div className='bg-white p-4 rounded border'>
        <div>
          ...
          <p className='text-black text-xl mb-6'>
            Fill out the details below to publish your market. You can choose
            either a weekly schedule or specific random dates.
          </p>
        </div>
        <p className='text-black'>
          LivLoco will never sell or share private account information. However,
          public profile fields (name, address, schedule) will be visible to
          visitors when shared.
        </p>
      </div>
