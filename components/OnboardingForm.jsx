...
export default function OnboardingForm({ email }) {
  ...
  const submit = async (e) => {
    ...
    // form.set('email_memmessage_notification', alerts ? 'true' : 'false'); // TODO: Implement email notification feature later
      ...
      >
        ...
        <div>
          ...
          <p className='mt-1 text-xs text-gray-500'>
            No one will ever get this information directly from Livloco unless
            you post is in your profile.
          </p>
        </div>
        ...
        <fieldset className='bg-gray-50/80 rounded-lg border border-gray-200 p-3 space-y-3'>
          <legend className='font-semibold px-1'>
            Choose a profile type (optional)
          </legend>
          ...
          <label className='inline-flex items-center gap-2'>
            ...
            />
            <span>
              Skip for now. I just want to be a Livloco Co-op member and just
              peruse other members' LocoBusinesses.
            </span>
          </label>
          <h1 className='font-semibold'>
            Each Livloco member can add one of these two choices below, at no
            additional cost to your yearly Livloco Co-op fees. These can also be
            added later in the profile section, when you are ready.{' '}
          </h1>
