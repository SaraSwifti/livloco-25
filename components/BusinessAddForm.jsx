  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && res.id) {
        ...
        alert(
          res.error ||
            'There was a problem saving your business. Please try again.'
        )
      }
    } catch (err) {
      console.error('Form submission failed:', err)
      alert(
        'There was a problem saving your business. Please check your inputs and try again.'
      )
    }
  }
        ...
        <div className='flex items-center p-2 gap-3'>
          ...
          >
            ...
            <span className='text-red-500'>
              Minimum of 1 Selling and 1 Need required
            </span>
            <br />
            <span className='text-black'>
              {' '}
              (This is what keeps the co-op working together!)
            </span>
          </label>
        </div>
      </div>
