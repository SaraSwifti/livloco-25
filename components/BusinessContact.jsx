    ...
    return (  
        <>
            <div className='bg-white p-6 rounded-lg shadow-md text-center md:text-left'>
                ...
                <div>
                    <h1 className="text-2xl font-bold text-green-900">Storefront Hours</h1>
                    <h1 className="text-xl text-green-900">{locomem.locobiz_address.biz_phone}</h1>
                    <h1 className="text-xl text-green-900">{locomem.locobiz_address.add_line1}</h1>
                    <h1 className="text-xl text-green-900">{locomem.locobiz_address.add_line2}</h1>
                    <h1 className="text-xl text-green-900">{locomem.locobiz_address.city}{`, `} {locomem.locobiz_address.state}{` ` }{locomem.locobiz_address.zipcode}</h1>
